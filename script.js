...
//დავალება 1:
//მოცემული ლინკიდან https://reqres.in/api/users?page=2 წამოიღეთ უსერების იმეილები და სურათები fetchით წამოღებული ინფორმაცია აამუშავეთ პრომისით;
...
document.getElementById('api').appendChild(li);
});
